...
from jinja2 import Environment, FileSystemLoader, TemplateError, TemplateSyntaxError, UndefinedError
...
class SmartTemplateRegistry:
    ...
    def register_pattern(self, pattern_func: Callable[..., dict[str, str] | None]) -> None:
    ...
    def _make_key(self, obj_type: type, model: type | None, variation: EnumStr | None) -> str:
    ...
    def _convention_based_name(self, obj_type: type, model: type | None, variation: EnumStr | None) -> str:
        ...
        Converts CamelCase to snake_case and builds path structure.
        """
...
class SmartTemplates:
    ...
    def render_safe(self, template_name: str, context: dict[str, Any]) -> tuple[str, RenderError | None]:
