...
class TestBusinessLogic:
    ...
    def test_school_properties(self):
        ...
        expected_address = f"{school.address}, {school.city}, {school.state} {school.zip_code}"
...
class TestUtilityFunctions:
    ...
    def test_get_students_by_status(self):
        ...
        completed_students = get_students_by_status(enrollments, EnrollmentStatus.COMPLETED)
...
class TestIntegration:
    ...
    def test_business_scenarios(self):
        ...
        for enrollment in enrollments:
            ...
            assert template_dict["status"] in ["active", "completed", "reattempt", "dropped"]
    ...
    def test_template_context_data_quality(self):
        ...
        for enrollment in enrollments:
            if enrollment.student:
                ...
                assert enrollment_context["status"] in EnrollmentStatus.__members__.values()