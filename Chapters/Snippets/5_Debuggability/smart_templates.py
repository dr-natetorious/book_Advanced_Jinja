...
class SmartTemplates:
    ...
    def __init__(
        self, directory: str, registry: SmartTemplateRegistry | None = None, **kwargs
    ):
        # Create Jinja2 environment
        loader = (
            FileSystemLoader(directory)
            if isinstance(directory, str)
            else FileSystemLoader(directory)
        )
    ...
    def _safe_get(self, obj: Any, key: str, default: Any = None) -> Any:
        ...
        try:
            ...
            elif isinstance(obj, dict) and key in obj or hasattr(obj, "__getitem__"):
                return obj[key]
            else:
                return default
...
class SmartFastApiTemplates(SmartTemplates):
    ...
    def prepare_context(
        self, data: BaseModel | dict[str, Any], request: Any
    ) -> dict[str, Any]:
    ...
    def create_fallback_error_html(
        self, error: RenderError | None, message: str = "An error occurred"
    ) -> str:
            ...
            async def wrapper(request, *args, **kwargs):
                try:
                    ...
                    if wants_json:
                        ...
                        # Render template
                        content, error = templates_instance.render_safe(
                        ...
                        if error:
                            ...
                            if error_render_error:
                                return HTMLResponse(
                                    content=templates_instance.create_fallback_error_html(
                                        error
                                    ),
                                    status_code=500,
                                )
